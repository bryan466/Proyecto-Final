...
<head>
    ...
    <link rel='stylesheet' type='text/css'  href='css/estilos.css?v=0.0.19'/>
		...
		<div class="menu-lateral">
				...
				<div  class="lista-menu">
					<ul class="lista-menu-1">
						...
						<strong><li><a href="login.php"  style="color:#FF0000;" >Inciar sesion</a></li></strong><br>
						<strong><li><a href="ventanamodal.php"  style="color:#FF0000;">ejemplo</a></li></strong>
					</ul>
				</div>
				<br>
				<br>
